...
const Catagories = () => {
  ...
  return (
    <div
      className={`max-w-screen-2xl container mx-auto xl:px-24 px-4 py-16 text-gray-800 ${
        isDarkMode ? "dark" : ""
      }`}
    >
